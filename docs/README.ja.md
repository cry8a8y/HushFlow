...
- **8+ カラーテーマ** — ティール、トワイライト、アンバー + コミュニティテーマ（Catppuccin、Dracula、Nord、Solarized、Gruvbox）
- **セッション統計** — 呼吸回数、マインドフル時間、連続日数を `hushflow stats` で確認
- **汎用CLIラッパー** — `hushflow wrap -- <任意のコマンド>` であらゆる待ち時間に呼吸を
- **サウンド統合** — 呼吸の切り替え時にオプションのチャイム音
