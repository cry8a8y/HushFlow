...
(
    ...
    assert_config_key "$CF" "animation" "random" "claude-fresh: animation=random"
...
(
    ...
    assert_config_key "$CF" "animation" "random" "gemini-fresh: animation=random"
)
...
(
    ...
    assert_config_key "$CF" "animation" "random" "codex-fresh: animation=random"
)
